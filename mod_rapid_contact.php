...
if (isset($_POST["rp_email"])) {
  ...
  if ($enable_anti_spam == '1' & $enable_anti_spam != 0) {
...
print '
       <form '.$url.' id="'.$form_id.'" method="post" class="form_rapid_contact">' . "\n" .
...
if ($anti_spam_position == 0) {
  ...
  // $name_placeholder = ($label_pos == '2') ? ' placeholder="Name"' : '';
  ...
  // print '<input class="rapid_contact form-control inputbox ' . $email_class . $mod_class_suffix . '" type="text" name="rp_text" id="'.$form_id.'_email" size="'.$emailWidth.'" value="'.$CORRECT_EMAIL.'" '.$name_placeholder.'/>';
  ...
  print '<input class="rapid_contact form-control inputbox ' . $email_class . $mod_class_suffix . '" type="text" name="rp_name" id="'.$form_id.'_email" size="'.$emailWidth.'" value="'.$CORRECT_EMAIL.'" '.$email_placeholder.'/>';
...
if ($anti_spam_position == 1 & $enable_anti_spam != 0) {
...
print '<button class="rapid_contact btn meta-btn ' . $mod_class_suffix . '" type="submit" value="' . $buttonText . '"/>';
echo '<span>' . $buttonText . '</span><i class="fa fa-arrow-right"></i>';
echo '</button>';
print '</div>';
