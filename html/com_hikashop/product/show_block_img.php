...
<?php
	...
	// 	$firstThunb = true;
		foreach($this->element->images as $image) {
			// echo var_dump($image);
			?>
      <img src="media/com_hikashop/upload/<?php echo $image->file_path; ?>" class="img-fluid" data-toggle="modal" data-target="#<?php echo $image->file_id?>">
    <!-- </a> -->
<?php
	}
	foreach($this->element->images as $image) {
	...
	<!-- <div class="modal-header">
	  ...
	  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <img src="media/com_hikashop/upload/<?php echo $image->file_path; ?>" class="img-fluid">
      </div>
	</div>
	</div>
	</div>
