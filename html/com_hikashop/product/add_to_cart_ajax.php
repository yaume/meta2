...
?>
	<form action="<?php echo hikashop_completeLink($classical_url); ?>" method="post" class="form-inline" name="hikashop_product_form_<?php echo $this->row->product_id.'_'.$this->params->get('main_div_name'); ?>" enctype="multipart/form-data">
<?php
}
