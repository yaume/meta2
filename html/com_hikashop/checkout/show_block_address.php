...
?>
			...
			<div style="float:right">
				<button onclick="return window.checkout.submitAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>);" class="<?php echo $this->config->get('css_button','hikabtn'); ?> hikashop_checkout_address_ok_button"> <?php echo JText::_('HIKA_OK'); ;?><i class="fa fa-check"></i></button>
			
			<button onclick="return window.checkout.refreshAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>);" class="<?php echo $this->config->get('css_button','hikabtn'); ?> hikashop_checkout_address_cancel_button"><?php echo JText::_('HIKA_CANCEL'); ;?><i class="fa fa-times"></i></button></div>
<?php
	}
