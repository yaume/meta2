...
?>
	<fieldset class="hika_address_field hikashop_checkout_checkout_address_block hkform-horizontal">
<?php
...
?>
<!-- <div class="control-group hikashop_checkout_address_same" id="hikashop_checkout_address_<?php echo $this->step . '_' . $this->module_position .'_same'; ?>">
...
?><div class="control-group hikashop_address_required_info_line">
...
?>
		<div class="hika_address_element">
			<div class="hika_edit">
				<a href="<?php echo hikashop_completeLink($update_url);?>" onclick="return window.checkout.editAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>,<?php echo (int)$cart->cart_billing_address_id; ?>);" title="<?php echo JText::_('HIKA_EDIT'); ?>" class="btn"><i class="fa fa-pencil"></i><span><?php echo JText::_('HIKA_EDIT'); ?></span></a>
				<a href="<?php echo hikashop_completeLink($delete_url);?>" onclick="return window.checkout.deleteAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>,<?php echo (int)$cart->cart_billing_address_id; ?>);" title="<?php echo JText::_('HIKA_DELETE'); ?>" class="btn"><i class="fa fa-trash"></i><span><?php echo JText::_('HIKA_DELETE'); ?></span></a>
			</div>
...
?>
		<div class="hika_address_element">
			<div class="hika_edit">
				...
				<a href="<?php echo hikashop_completeLink($update_url);?>" onclick="return window.checkout.editAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>,<?php echo (int)$address->address_id; ?>);" title="<?php echo JText::_('HIKA_EDIT'); ?>" class="btn"><i class="fa fa-pencil"></i> <span><?php echo JText::_('HIKA_EDIT'); ?></span></a>
				<a href="<?php echo hikashop_completeLink($delete_url);?>" onclick="return window.checkout.deleteAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>,<?php echo (int)$address->address_id; ?>);" title="<?php echo JText::_('HIKA_DELETE'); ?>" class="btn"><i class="fa fa-trash"></i> <span><?php echo JText::_('HIKA_DELETE'); ?></span></a>
			</div>
			<div class="hika_address_display">
<?php
...
?>
		<button onclick="return window.checkout.newAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>, 'billing');" class="<?php echo $this->config->get('css_button','hikabtn'); ?> hikabtn-success hikashop_checkout_address_new_button"><span><?php echo JText::_('HIKA_NEW'); ?></span><i class="fa fa-plus"></i></button>
<?php
}
?>
	</fieldset>
...
?>
			<div class="hika_address_element">
				<div class="hika_edit">
					<a href="<?php echo hikashop_completeLink($update_url);?>" onclick="return window.checkout.editAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>,<?php echo (int)$shipping_address_id; ?>);" title="<?php echo JText::_('HIKA_EDIT'); ?>"><i class="fa fa-pencil"></i> <span><?php echo JText::_('HIKA_EDIT'); ?></span></a>
...
?>
			<div class="hika_address_element">
				<div class="hika_edit">
					...
					<a href="<?php echo hikashop_completeLink($update_url);?>" onclick="return window.checkout.editAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>,<?php echo (int)$address->address_id; ?>);" title="<?php echo JText::_('HIKA_EDIT'); ?>"><i class="fa fa-pencil"></i> <span><?php echo JText::_('HIKA_EDIT'); ?></span></a>
