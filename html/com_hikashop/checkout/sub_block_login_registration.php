...
?>
	...
	<label id="emailmsg" for="register_email" class="<?php echo $labelcolumnclass;?> hkcontrol-label" title=""><?php echo JText::_('HIKA_EMAIL'); ?><span class="hikashop_field_required_label">*</span></label>
...
?>
	...
	<?php
		...
		echo $this->fieldsClass->getFieldName($field, true);
	?>
...
if(!empty($this->options['affiliate_registration'])) {
	...
	if(!empty($plugin)) {
?>
	<div class="hikashop_registration_affiliate_line">
...
?>
	<div class="hikashop_registration_same_address_line" id="hikashop_address_<?php echo $this->step . '_' . $this->module_position . '_same_address'; ?>">
		<div class="<?php echo $labelcolumnclass;?> hkcontrol-label"></div>
		<div class="<?php echo $inputcolumnclass;?>">
...
?>
	<div class="hikashop_registration_required_info_line">
		<div class="<?php echo $labelcolumnclass;?> hkcontrol-label"></div>
