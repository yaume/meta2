...
<!--{ENDIF:TPL_HEADER}-->
	<table class="w600" style="font-family:Arial, Helvetica, sans-serif;font-size:12px;line-height:18px;margin:auto;background-color:#fff;text-align:center;" border="0" cellspacing="0" cellpadding="0" width="600">
